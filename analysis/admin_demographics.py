...
def age_group(a):
    ...
    if 25 <= a <= 34: return "25–34"
    if 35 <= a <= 44: return "35–44"
    if 45 <= a <= 54: return "45–54"
    if 55 <= a <= 64: return "55–64"
    if a >= 65:       return "65+"
    return None
...
def build_figure(all_rows, single_row=None, user_id=None):
    ...
    return {
        ...
        "age": {
            ...
            "subtitle": subtitle_fmt(age_group(single_row["Age"]) if single_row else None)
        },
