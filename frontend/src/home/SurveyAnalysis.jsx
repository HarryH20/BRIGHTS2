...
export default function SurveyAnalysis({ user, onLogout }) {
  ...
  return (
    <HomeLayout user={user} onLogout={onLogout} title={`Survey Analysis — ${surveyId}`}>
      <div style={card}>
        <p style={muted}>Placeholder for analysis view.</p>
        <div style={{ display: "flex", gap: 12 }}>
          <Link to={`/surveys/${surveyId}/results`} style={pill}>Go to Results →</Link>
